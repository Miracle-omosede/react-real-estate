...
const About = () => {
  return (
    <div className="wrapper flex flex-col w-full h-screen overflow-hidden relative">
      {/* --Heading--- */}
      <motion.div variants={textVariant()} className="w-full flex flex-col justify-center items-center">
      ...
      <div className="flex flex-row ml-32">
        <div className='mt-20 flex flex-wrap gap-10'>
          <Tilt className="xs:w-[250px] w-full cursor-pointer">
            <motion.div variants={fadeIn("right", "spring", 0.5 * indexedDB, 0.75)} className='w-full p-[1px] rounded-[20px] border- shadow-card'>
                 <div options={{
                  max: 45,
                  scale: 1,
                  speed: 450
                 }} className='bg-[#6e5031] py-5 px-12 min-h-[280px] flex justify-evenly items-center flex-col rounded-[20px]'>
                      <svg width="" height="" viewBox="0 0 24 18" className='w-[86px]' fill="none" xmlns="http://www.w3.org/2000/svg">
