...
const Hero = () => {
  return (
    <div className="w-full bg-[#FCFBF4] relative">
      <div className="relative w-full h-full">
        ...
        <div className="flex flex-row text-[40px] absolute bottom-0 right-0">
      ...
      <div className="bg-[#6e5031] md:absolute -bottom-40  md:w-[500px] md:h-[200px]">
